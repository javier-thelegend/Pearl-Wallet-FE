      ...
      <table {...getTableProps()}>
        ...
        <tr>
            <th className={AccountTableCss.filter} colSpan={5}>
                ...
                />
                <Button className="button-new-in-filter" variant="primary" title='Add a New Income / Expenses' onClick={handleNewIncomeExpenses}>
                    <Icon.FileEarmark color='white' size={15}/> New Income / Expenses
                </Button>
            </th>
          </tr>
